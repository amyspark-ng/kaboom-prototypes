...
`), font: nn, pos: T(t, -t), anchor: "botleft", size: 16, width: we() * 0.6, lineSpacing: t / 2, fixed: true, styles: { time: { color: J(127, 127, 127) }, info: { color: J(255, 255, 255) }, error: { color: J(255, 0, 127) } } });
  ...
  // src/scenes/newgroundsStuff.js
  var theText;
  var icon;
  var userIcon;
  function newgroundsText() {
    theText = add([
  ...
  var loadingButton = 512 - 100;
  function newgroundsGetConnectionStatus() {
  ...
  function gamescene() {
    return scene("gamescene", () => {
      ...
      function onScoresLoaded(scores, board, options2) {
        if (scores.length == void 0) {
          scoresFromNg = [scores];
        } else {
          scoresFromNg = scores;
        }
  ...
  var gottenData = getData("testy-test-save");
  if (gottenData) {
