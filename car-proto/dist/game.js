    ...
    return scene("gamescene", () => {
      ...
      onUpdate(() => {
        ...
        if (!(isKeyDown("up") || isKeyDown("down"))) {
          if (speed > 0) {
            speed -= 10;
            if (speedNeedle.angle > 60)
              speedNeedle.angle -= 2.3;
          } else {
            if (speed < 0)
              speed += 15;
            if (speedNeedle.angle > 60)
              speedNeedle.angle -= 3.25;
          }
        }
